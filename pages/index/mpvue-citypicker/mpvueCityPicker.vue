...
<script>
	import getTimeData  from './city-data/timeData';	
/* 	const cityData = timeData.hourData;
	const areaData = timeData.minuteData; */
	...
	export default {
		...
		watch: {
			...
			timeData(value){ 
				//value.end_time value.start_time  step_second
		             var res = getTimeData(value.start_time,value.end_time,value.step_second); 
					  this.cityData = res.hourData; 
					  this.areaData = res.minuteData; 
					  this.provinceData = this.provinceDataList = res.daysData;					  
					  this.cityDataList = this.cityData[0];
					  this.areaDataList = this.areaData[0][0];
					  this.init();
			}
		},
		methods: {
			...
			pickerChange(e) {
				...
				if (this.pickerValue[0] !== changePickerValue[0]) {
					...
					// 第二级滚动 
					//console.log(areaData[changePickerValue[0]][changePickerValue[1]][0]);
